...
to do-pins
  ...
  let yindex 7.25
  repeat 6 [
    crt 1 [ set shape "square 2" set color lime set size .9 setxy xindex yindex]
    set xindex xindex + .85
  ]
  set xindex .73
  set yindex 7.2
  repeat 8 [
    crt 1 [ set shape "square 2" set color sky set size .9 setxy xindex yindex]
    set xindex xindex + .85
  ]
  ...
  set yindex -8.5
  repeat 8 [
    crt 1 [ set shape "square 2" set color yellow set size .9 setxy xindex yindex]
    set xindex xindex + .85
  ]
  ...
  repeat 4 [
    crt 1 [ set shape "square 2" set color orange set size .9 setxy xindex yindex]
    set xindex xindex + .85
  ]
